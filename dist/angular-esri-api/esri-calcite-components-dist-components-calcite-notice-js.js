...
async function fetchIcon({ icon, scale }) {
  ...
  if (!requestCache[id]) {
    requestCache[id] = fetch(Object(_stencil_core_internal_client__WEBPACK_IMPORTED_MODULE_0__["getAssetPath"])(`./assets/icon/${id}.json`))
      .then((resp) => resp.json())
      .catch(() => {
...
let Icon = class extends _stencil_core_internal_client__WEBPACK_IMPORTED_MODULE_0__["HTMLElement"] {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
Icon = /*@__PURE__*/ Object(_stencil_core_internal_client__WEBPACK_IMPORTED_MODULE_0__["proxyCustomElement"])(Icon, [1, "calcite-icon", {
    "icon": [513],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return connectConditionalSlotComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return disconnectConditionalSlotComponent; });
/* harmony import */ var _stencil_core_internal_client__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @stencil/core/internal/client */ "MQUK");
...
function connectConditionalSlotComponent(component) {
  if (!mutationObserver) {
    mutationObserver = Object(_observers_js__WEBPACK_IMPORTED_MODULE_1__["c"])("mutation", processMutations);
  }
...
function processMutations(mutations) {
  mutations.forEach(({ target }) => {
    Object(_stencil_core_internal_client__WEBPACK_IMPORTED_MODULE_0__["forceUpdate"])(target);
  });
}
...
/* harmony import */ var _conditionalSlot_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./conditionalSlot.js */ "NIDn");
/* harmony import */ var _icon_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./icon.js */ "4Jhp");
/*!
 * All material copyright ESRI, All Rights Reserved, unless otherwise specified.
 * See https://github.com/Esri/calcite-components/blob/master/LICENSE.md for details.
 */
...
let Notice = class extends _stencil_core_internal_client__WEBPACK_IMPORTED_MODULE_0__["HTMLElement"] {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  //--------------------------------------------------------------------------
  connectedCallback() {
    Object(_conditionalSlot_js__WEBPACK_IMPORTED_MODULE_3__["c"])(this);
  }
  disconnectedCallback() {
    Object(_conditionalSlot_js__WEBPACK_IMPORTED_MODULE_3__["d"])(this);
  }
  componentWillLoad() {
    this.requestedIcon = Object(_dom_js__WEBPACK_IMPORTED_MODULE_2__["s"])(_interfaces_js__WEBPACK_IMPORTED_MODULE_1__["S"], this.icon, this.color);
  }
  render() {
    ...
    return (Object(_stencil_core_internal_client__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: CSS.container }, this.requestedIcon ? (Object(_stencil_core_internal_client__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: CSS.icon }, Object(_stencil_core_internal_client__WEBPACK_IMPORTED_MODULE_0__["h"])("calcite-icon", { icon: this.requestedIcon, scale: this.scale === "l" ? "m" : "s" }))) : null, Object(_stencil_core_internal_client__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: CSS.content }, Object(_stencil_core_internal_client__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: SLOTS.title }), Object(_stencil_core_internal_client__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: SLOTS.message }), Object(_stencil_core_internal_client__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: SLOTS.link })), hasActionEnd ? (Object(_stencil_core_internal_client__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: CSS.actionsEnd }, Object(_stencil_core_internal_client__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: SLOTS.actionsEnd }))) : null, this.dismissible ? closeButton : null));
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
...
Notice = /*@__PURE__*/ Object(_stencil_core_internal_client__WEBPACK_IMPORTED_MODULE_0__["proxyCustomElement"])(Notice, [1, "calcite-notice", {
    "active": [1540],
    "color": [513],
    "dismissible": [516],
    "icon": [520],
...
function defineCustomElement$1() {
  ...
  components.forEach(tagName => { switch (tagName) {
    ...
    case "calcite-icon":
      if (!customElements.get(tagName)) {
        Object(_icon_js__WEBPACK_IMPORTED_MODULE_4__["d"])();
      }
      break;
  } });
}
